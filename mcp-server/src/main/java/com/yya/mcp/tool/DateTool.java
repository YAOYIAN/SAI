...
public class DateTool {
    @Tool(description = "获取储同学当前的时间")
    public String getCurrentTimeForChuTongXue() {
        log.info("========== 调用MCP工具：getCurrentTimeForChuTongXue() ==========");

        String currentTime = String.format("储同学，当前的时间是 %s",
